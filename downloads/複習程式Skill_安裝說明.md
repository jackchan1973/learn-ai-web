...
這份內容是給 Codex 或 Claude Code 使用的「複習程式 Skill」安裝說明。

用途：

- 把老師提供的題目、答案、解析、圖片或 PDF 整理成小程式
- 製作可在手機和電腦使用的網頁版複習 / 測驗 / 作業工具
- 支援學生填姓名、作答、自動判分、顯示解析
- 可規劃 Google Sheet 回收作答結果
...
把下面這段話貼給 Claude Code：

```text
請幫我安裝「複習程式 Skill」。

請在我的電腦建立這個資料夾：
~/.claude/skills/review-app-builder/
...
7. 確認後再製作小程式。
8. 完成後用瀏覽器驗證桌面和手機版，至少檢查 360px 寬度。
